"""
Test trigger_life_cycle_python.
"""
...
def test_trigger_life_cycle_python():
    ...
    if not is_started:
        print("The trigger_life_cycle_python is not started after 30 seconds.")
    ...
    try:
        ...
        if not is_stopped:
            print(
                "The trigger_life_cycle_python can not stop after 30 seconds."
            )
            server.kill()
