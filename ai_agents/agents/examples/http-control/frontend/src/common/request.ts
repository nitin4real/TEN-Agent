...
export const apiGenAgoraData = async (config: GenAgoraDataConfig) => {
  // the request will be rewrite at proxy.ts to send to $AGENT_SERVER_URL
...
> => {
  ...
  const resp: any = await axios.post(`/api/dev/v1/apps/addons`, {
    base_dir: ".",
  });
...
export const apiLoadApp = async (): Promise<any> => {
  const resp: any = await axios.post(`/api/dev/v1/apps/load`, {
    base_dir: ".",
  });
  return resp.data.data;
};
...
export const apiFetchGraphNodes = async (graphId: string): Promise<Node[]> => {
  ...
  const resp: any = await axios.post(`/api/dev/v1/graphs/nodes`, {
    graph_id: graphId,
  });
...
export const apiFetchGraphConnections = async (
  ...
  const resp: any = await axios.post(`/api/dev/v1/graphs/connections`, {
    graph_id: graphId,
  });
...
export const apiGetDefaultProperty = async (module: string): Promise<any> => {
  const resp: any = await axios.post(`/api/dev/v1/extensions/property/get`, {
    addon_name: module,
    base_dir: ".",
  });
  return resp.data.data;
...
export const apiAddNode = async (
  ...
  const resp: any = await axios.post(`/api/dev/v1/graphs/nodes/add`, {
    graph_id: graphId,
    name,
    addon: module,
    property: properties,
...
export const apiReplaceNodeModule = async (
  ...
  const resp: any = await axios.post(`/api/dev/v1/graphs/nodes/replace`, {
    graph_id: graphId,
    name,
    addon: module,
    property: properties,
...
export const apiRemoveNode = async (
  ...
  const resp: any = await axios.post(`/api/dev/v1/graphs/nodes/delete`, {
    graph_id: graphId,
    name,
    addon: module,
  });
...
export const apiAddConnection = async (
  ...
  const resp: any = await axios.post(`/api/dev/v1/graphs/connections/add`, {
    graph_id: graphId,
...
export const apiRemoveConnection = async (
  ...
  const resp: any = await axios.post(`/api/dev/v1/graphs/connections/delete`, {
    graph_id: graphId,
    src_extension: srcExtension,
    msg_type: msgType,
    msg_name: msgName,
...
> => {
  const resp: any = await axios.get(`/api/dev/v1/addons/default-properties`);
