...
@patch("polly_tts.extension.PollyTTSClient")
def test_sequential_requests_state_machine(MockPollyTTSClient):
    """
    ...
    MockPollyTTSClient.return_value = mock_instance
    ...
    tester.set_test_mode_single("polly_tts", json.dumps(config))
    tester.run()
...
@patch("polly_tts.extension.PollyTTSClient")
def test_request_state_transitions(MockPollyTTSClient):
    """
