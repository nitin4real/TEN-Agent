...
def test_sequential_requests_state_machine(MockTencentTTSClient):
    """
    ...
    MockTencentTTSClient.return_value = mock_instance
    ...
    def mock_client_init(config, ten_env, vendor):
        mock_instance.start = AsyncMock(side_effect=streamer.start)
...
@patch("tencent_tts_python.extension.TencentTTSClient")
def test_request_state_transitions(MockTencentTTSClient):
    """
