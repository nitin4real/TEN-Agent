...
def test_dump_functionality(MockSarvamTTSClient):
    ...
    tester.set_test_mode_single("sarvam_http_tts", json.dumps(dump_config))
...
class ExtensionTesterFlush(ExtensionTester):
    def __init__(self):
        ...
        self.sample_rate = 22050  # Sarvam TTS sample rate
...
@patch("sarvam_http_tts.extension.SarvamTTSClient")
def test_flush_logic(MockSarvamTTSClient):
    """
