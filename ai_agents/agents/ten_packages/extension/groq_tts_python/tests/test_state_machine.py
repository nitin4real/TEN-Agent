...
@patch("groq_tts_python.extension.GroqTTSClient")
def test_sequential_requests_state_machine(MockGroqTTSClient):
    """
    ...
    MockGroqTTSClient.return_value = mock_instance
    ...
    tester.set_test_mode_single("groq_tts_python", json.dumps(config))
    tester.run()
...
@patch("groq_tts_python.extension.GroqTTSClient")
def test_request_state_transitions(MockGroqTTSClient):
    """
